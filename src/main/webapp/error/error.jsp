 ...
 <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="eng" lang="eng">
  ...
  <title>Coffee Break : 500</title>
   ...
   <div class="controller">
    ...
    <p class="details">There was a problem<br /><br />The page you are looking for is not here or moved.
    </p> 
    <pre>
    <%if(exception!=null){
    ...
    <a href="<%=serverUrl %>">Back to homepage</a> 
    </div> <!-- home page --> 
    </div> <!-- social-icons --> 
    <div class="social">
